...
```groovy
compile 'com.github.shareme:GWSRippleDecoView:{latest-release-number}@aar'
```
...
Then wrap any layout with a com.github.shareme.gwsrippledecoview.library.RippleDecoratorView element:
...
'''java
    ...
    </com.github.shareme.gwsrippledecorview.RippleDecoratorView>
'''
